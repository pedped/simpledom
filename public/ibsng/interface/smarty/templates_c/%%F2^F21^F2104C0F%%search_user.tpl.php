<?php /* Smarty version 2.6.13, created on 2015-03-17 01:52:04
         compiled from admin/user/search_user.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'tabTable', 'admin/user/search_user.tpl', 10, false),array('block', 'tabContent', 'admin/user/search_user.tpl', 12, false),array('block', 'addAttributeSkel', 'admin/user/search_user.tpl', 67, false),array('block', 'listTable', 'admin/user/search_user.tpl', 110, false),array('block', 'addRelatedLink', 'admin/user/search_user.tpl', 135, false),array('block', 'setAboutPage', 'admin/user/search_user.tpl', 147, false),array('function', 'reportPages', 'admin/user/search_user.tpl', 130, false),)), $this); ?>
...
unset($_smarty_tpl_vars);
 ?>
    ...
    <tr><td colspan=20>
    	<?php $this->_tag_stack[] = array('addAttributeSkel', array('form_name' => 'search_user','title' => 'Attributes to Edit')); $_block_repeat=true;smarty_block_addAttributeSkel($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
			<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "admin/user/search_user/search_user_attributs.tpl", 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
    	<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_addAttributeSkel($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>
    </td></tr>
 ...
 ?>
	...
	<?php if ($this->_tpl_vars['can_change']): ?>
		...
		<?php $this->_tag_stack[] = array('listTable', array('no_header' => 'TRUE','no_foot' => 'TRUE','table_width' => "50%")); $_block_repeat=true;smarty_block_listTable($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
    		<?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "admin/report/skel_conditions.tpl", 'smarty_include_vars' => array('name' => 'edit_attrs','form_name' => 'edit_user','title' => 'Attributes to Edit','normal_username_checked' => 'FALSE','voip_username_checked' => 'FALSE','inc' => "admin/user/edit_select_attrs.tpl")));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
