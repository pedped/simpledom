<?php /* Smarty version 2.6.13, created on 2015-03-17 01:52:51
         compiled from plugins/group/view/voip_charge.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'viewTable', 'plugins/group/view/voip_charge.tpl', 1, false),array('block', 'addEditTD', 'plugins/group/view/voip_charge.tpl', 2, false),array('block', 'ifHasAttr', 'plugins/group/view/voip_charge.tpl', 9, false),array('function', 'editCheckBox', 'plugins/group/view/voip_charge.tpl', 4, false),array('function', 'helpicon', 'plugins/group/view/voip_charge.tpl', 14, false),array('modifier', 'escape', 'plugins/group/view/voip_charge.tpl', 10, false),)), $this); ?>
<?php $this->_tag_stack[] = array('viewTable', array('title' => 'VoIP Charge','nofoot' => 'TRUE')); $_block_repeat=true;smarty_block_viewTable($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
	...
	<?php echo '';  if ($this->_tpl_vars['can_change']):  echo '';  echo smarty_function_editCheckBox(array('edit_tpl_name' => 'voip_charge'), $this); echo '';  endif;  echo 'VoIP Charge'; ?>
