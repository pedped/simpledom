<?php /* Smarty version 2.6.13, created on 2015-03-17 01:52:06
         compiled from admin/report/skel_conditions.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'listTableHeader', 'admin/report/skel_conditions.tpl', 6, false),array('block', 'multiTable', 'admin/report/skel_conditions.tpl', 18, false),array('function', 'eval', 'admin/report/skel_conditions.tpl', 22, false),)), $this); ?>
...
_check_all></td>
	...
	<?php $this->_tag_stack[] = array('multiTable', array()); $_block_repeat=true;smarty_block_multiTable($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
		<?php if (isset ( $this->_tpl_vars['inc'] )): ?>
		    <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => $this->_tpl_vars['inc'], 'smarty_include_vars' => array()));
$this->_tpl_vars = $_smarty_tpl_vars;
unset($_smarty_tpl_vars);
 ?>
		<?php elseif ($this->_tpl_vars['file_value']): ?>
			<?php echo smarty_function_eval(array('var' => $this->_tpl_vars['file_value']), $this);?>
