<?php /* Smarty version 2.6.13, created on 2015-03-17 01:52:51
         compiled from plugins/group/view/group_info.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'viewTable', 'plugins/group/view/group_info.tpl', 1, false),array('block', 'addEditTD', 'plugins/group/view/group_info.tpl', 2, false),array('function', 'editCheckBox', 'plugins/group/view/group_info.tpl', 4, false),)), $this); ?>
<?php $this->_tag_stack[] = array('viewTable', array('title' => 'Group Informations','nofoot' => 'TRUE')); $_block_repeat=true;smarty_block_viewTable($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
    <?php $this->_tag_stack[] = array('addEditTD', array('type' => 'left')); $_block_repeat=true;smarty_block_addEditTD($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
	    <?php echo '';  if ($this->_tpl_vars['can_change']):  echo ' ';  echo smarty_function_editCheckBox(array('edit_tpl_name' => 'group_info'), $this); echo ' ';  endif;  echo 'Group ID'; ?>
