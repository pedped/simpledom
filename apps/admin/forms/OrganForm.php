<?php
                            ...
                            $byuserid->setAttribute('class', 'form-control');$byuserid->addValidator(new PresenceOf(array(
                            ...
                            $phonenumber->setAttribute('class', 'form-control');$phonenumber->addValidator(new PresenceOf(array(
                            ...
                            $smscredit->setAttribute('class', 'form-control');$smscredit->addValidator(new PresenceOf(array(
                            ...
                            $interfaceurl->setAttribute('class', 'form-control');$interfaceurl->addValidator(new PresenceOf(array(
                            ...
                            $userinterface->setAttribute('class', 'form-control');$userinterface->addValidator(new PresenceOf(array(
                            ...
                            $status->setAttribute('class', 'form-control');$status->addValidator(new PresenceOf(array(
                            ...
                            $disablemessage->setAttribute('class', 'form-control');$disablemessage->addValidator(new PresenceOf(array(
                            ...
                            $date->setAttribute('class', 'form-control');$date->addValidator(new PresenceOf(array(
