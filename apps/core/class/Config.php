...
class Config {
    ...
    public static function GetDefaultCategoryProductImage($categoryID) {
        return "http://www.placehold.it/128x128";
    }

    public static function GetDefaultProductImageID() {
        return 12;
    }

    public static function GetDefaultSellerImageID() {
        return 12;
    }
