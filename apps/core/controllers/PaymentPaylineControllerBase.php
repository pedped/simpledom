    ...
    public function listAction($page = 1) {
        ...
        $paginator->
                setTableHeaders(array(
                    'ID', 'User ID', 'Date', 'Amount', 'Currency', 'Transaction ID', 'Payline ID Get', 'Payline Transaction ID', 'Done'
                ))->
                setFields(array(
                    'id', 'getUserName()', 'getDate()', 'amount', 'cur', 'usertransactionid', 'paylineidget', 'paylinetransactionid', 'getDoneTag()'
                ))->
                setEditUrl(
                        'edit'
                )->
